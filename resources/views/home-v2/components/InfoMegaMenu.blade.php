...
<div class="header-mega-menu info-mega-menu-v2 compact-menu" id="infoMegaMenuV2">
            ...
            <div class="carousel-media-viewport" id="exclusiveMediaViewport">
                ...
                <div class="carousel-item-simple active">
                    <div class="media-container-v2">
                        <iframe src="https://www.youtube.com/embed/hdxKTW1ER5w" title="Video Québec" class="slide-media-direct"></iframe>
                ...
                <div class="carousel-item-simple">
                     <div class="media-container-v2">
                        ...
                        <button class="expand-media-btn" onclick="openDedicatedImage('https://picsum.photos/800/1200?random=61', 'Paysage Québec')">
                            <i class="fas fa-expand"></i>
                        </button>
                    </div>
                </div>
    ...
    <div class="mega-menu-footer-btns">
        ...
        <a href="{{url('/landing/experiences-canada')}}" class="footer-btn btn-canada"><span>EXPÉRIENCES CANADA</span></a>
